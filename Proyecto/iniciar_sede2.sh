...
gnome-terminal -- bash -c "cd $(pwd) && java -cp 'target/classes:$HOME/.m2/repository/org/zeromq/jeromq/0.6.0/jeromq-0.6.0.jar' Gestor_Almacenamiento.ServidorGA_TCP replica $GA_PORT; exec bash" &
sleep 3
