...
gnome-terminal -- bash -c "cd $(pwd) && java -cp 'target/classes:$HOME/.m2/repository/org/zeromq/jeromq/0.5.3/jeromq-0.5.3.jar' Gestor_Almacenamiento.ServidorGA_TCP replica $GA_PORT; exec bash" &
sleep 3
